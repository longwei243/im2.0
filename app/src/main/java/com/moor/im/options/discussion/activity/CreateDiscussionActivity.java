...
public class CreateDiscussionActivity extends BaseActivity{
    ...
    private void setTitleBar() {
        ...
        titlebar_done.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if("".equals(groupName)) {
                    Toast.makeText(CreateDiscussionActivity.this, "请输入名称", Toast.LENGTH_SHORT).show();
                }else if(selectedUserList.size() == 0) {
                    Toast.makeText(CreateDiscussionActivity.this, "请选择成员", Toast.LENGTH_SHORT).show();
                }else {
    ...
    private void createGroup(String groupName) {
        ...
        Observable createGroupObservable = HttpManager.getInstance().createDiscussion(InfoDao.getInstance().getConnectionId(), memberList, groupName);
        createGroupObservable
                ...
                .subscribe(new Observer() {
                    ...
                    public void onNext(Object o) {
                        //创建成功了
                        dismissLoadingDialog();
                        Toast.makeText(CreateDiscussionActivity.this, "讨论组创建成功", Toast.LENGTH_SHORT).show();
                        RxBus.getInstance().send(new DiscussionCreateSuccess());
                        finish();
                    }
                });
