...
public class AlternateUnlocker extends LinearLayout implements IOnLeftRightChoice.IOnLeftRightProvider, OnClickListener {
     ...
     */
    @Override
    public void setTypeOfLock(IOnLeftRightChoice.TypeOfLock lock) {
        if(lock == IOnLeftRightChoice.TypeOfLock.CALL) {
