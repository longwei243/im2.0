...
package com.moor.im.common.views.swipeback;
...
/**
 * SwipeBackViewDragHelper is a utility class for writing custom ViewGroups. It offers a
...
public class SwipeBackViewDragHelper {
    private static final String TAG = "SwipeBackViewDragHelper";
    ...
    /**
     * A Callback is used as a communication channel with the SwipeBackViewDragHelper
     ...
     * the SwipeBackViewDragHelper with more information about the state of the parent
    ...
    public static abstract class Callback {
         ...
         * invokes one of these methods, the SwipeBackViewDragHelper will enter
         ...
         * place and the SwipeBackViewDragHelper will return to {@link #STATE_IDLE}.
         * </p>
         *
         ...
         * <p>
         * SwipeBackViewDragHelper may call this method multiple times for the same view
    ...
    /**
     * Factory method to create a new SwipeBackViewDragHelper.
     *
     * @param forParent Parent view to monitor
     * @param cb        Callback to provide information and receive events
     * @return a new SwipeBackViewDragHelper instance
     */
    ...
    /**
     * Apps should use SwipeBackViewDragHelper.create() to get a new instance. This will
    ...
    public void captureChildView(View childView, int activePointerId) {
        if (childView.getParent() != mParentView) {
            throw new IllegalArgumentException("captureChildView: parameter must be a descendant "
                    + "of the SwipeBackViewDragHelper's tracked parent view (" + mParentView + ")");
        }
     ...
     * (to the best of the SwipeBackViewDragHelper's knowledge).
     * <p>
    ...
    public boolean shouldInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEventCompat.ACTION_POINTER_DOWN: {
                ...
                // A SwipeBackViewDragHelper can only manipulate one view at a time.
