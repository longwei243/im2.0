...
package com.moor.im.tcp.logger.format;
...
import com.moor.im.tcp.logger.format.command.CategoryFormatCommand;
import com.moor.im.tcp.logger.format.command.ClientIdFormatCommand;
import com.moor.im.tcp.logger.format.command.DateFormatCommand;
import com.moor.im.tcp.logger.format.command.FormatCommandInterface;
import com.moor.im.tcp.logger.format.command.MessageFormatCommand;
import com.moor.im.tcp.logger.format.command.NoFormatCommand;
import com.moor.im.tcp.logger.format.command.PriorityFormatCommand;
import com.moor.im.tcp.logger.format.command.ThreadFormatCommand;
import com.moor.im.tcp.logger.format.command.ThrowableFormatCommand;
import com.moor.im.tcp.logger.format.command.TimeFormatCommand;
...
public class PatternFormatter implements Formatter {
	 ...
	 * 
	 * @see Formatter#format(String, String, long,
	 *      Level, Object, Throwable)
	 */
	...
	/**
	 * @see Formatter#setProperty(String,
	 *      String)
	 */
