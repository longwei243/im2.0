 ...
 * 
 */
package com.moor.im.tcp.logger.config;
...
public class PropertyConfigurator {
	...
	public static final String[] APPENDER_CLASS_NAMES = { "com.moor.im.tcp.logger.appender.LogCatAppender",
			"com.moor.im.tcp.logger.appender.FileAppender" };

	public static final String[] FORMATTER_ALIASES = { "SimpleFormatter", "PatternFormatter" };

	public static final String[] FORMATTER_CLASS_NAMES = { "com.moor.im.tcp.logger.format.SimpleFormatter",
			"com.moor.im.tcp.logger.format.PatternFormatter" };
