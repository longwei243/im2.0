...
public enum DefaultLoggerRepository implements LoggerRepository, CommonLoggerRepository {
	...
	/**
	 * @see LoggerRepository#getRootLogger()
	 */
	...
	/**
	 * @see LoggerRepository#getLogger(String)
	 */
	...
	/**
	 * @see LoggerRepository#setLevel(String,
	 *      Level)
	 */
	...
	/**
	 * @see LoggerRepository#getEffectiveLevel(net.sf.microlog
	 *      .core.Logger)
	 */
	...
	/**
	 * @see LoggerRepository#contains(String)
	 */
	...
	/**
	 * @see LoggerRepository#numberOfLeafNodes()
	 */
