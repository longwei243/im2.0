 ...
 */
public class ErpAgentSpAdapter extends BaseAdapter{

    private Context context;

    private List<MAAgent> datas;

    public ErpAgentSpAdapter(Context context, List<MAAgent> datas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tv_name.setText(datas.get(position).displayName);
        return convertView;
    }
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tv_name.setText(datas.get(position).displayName);
        return convertView;
    }
