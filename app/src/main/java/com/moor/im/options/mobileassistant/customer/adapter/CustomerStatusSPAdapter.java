 ...
 */
public class CustomerStatusSPAdapter extends BaseAdapter{

    private Context context;

    private List<QueryData> datas;

    public CustomerStatusSPAdapter(Context context, List<QueryData> datas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = LayoutInflater.from(context).inflate(R.layout.sp_cust_layout,
                parent, false);
