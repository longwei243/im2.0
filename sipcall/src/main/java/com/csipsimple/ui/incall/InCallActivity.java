...
public class InCallActivity extends FragmentActivity implements IOnCallActionTrigger,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("电话界面进入了，session id 是:"+initialSession.getCallId());
        ...
        System.out.println("电话界面，添加了状态监听器");
    ...
    private class UpdateUIFromCallRunnable implements Runnable {
        ...
        public void run() {
            ...
            System.out.println("电话界面，更新电话状态");
            int mainsCalls = 0;
            int heldsCalls = 0;
    ...
    private BroadcastReceiver callStateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(SipManager.ACTION_SIP_CALL_CHANGED)) {
                System.out.println("监听器中收到电话状态改变");
                if (service != null) {
                    try {
                        synchronized (callMutex) {
