...
public class Callback {
  ...
  public void on_call_state(int call_id, pjsip_event e) {
    ...
    if (getClass() == Callback.class) pjsuaJNI.Callback_on_call_state(swigCPtr, this, call_id, pjsip_event.getCPtr(e), e);
    	else pjsuaJNI.Callback_on_call_stateSwigExplicitCallback(swigCPtr, this, call_id, pjsip_event.getCPtr(e), e);
