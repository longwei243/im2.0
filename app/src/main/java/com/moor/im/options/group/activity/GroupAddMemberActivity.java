...
public class GroupAddMemberActivity extends BaseActivity{
    ...
    private void addMemberAdmin(String groupId) {
        ...
        Observable createGroupObservable = HttpManager.getInstance().addGroupMember(InfoDao.getInstance().getConnectionId(), groupId, memberIds);
        createGroupObservable
                ...
                .subscribe(new Observer() {
                    ...
                    public void onNext(Object o) {
                        //成功了
                        dismissLoadingDialog();
                        Toast.makeText(GroupAddMemberActivity.this, "群组成员添加成功", Toast.LENGTH_SHORT).show();
